...
bool check_complete(int x1, int v1, int x2, int v2){
    if(x1>x2 and v1>=v2){return false;}
    if(x2>x1 and v2>=v1){return false;}
    if(x1+v1==x2+v2){return true;}
    return check_complete(x1+v1,v1,x2+v2,v2);
    
}
string kangaroo(int x1, int v1, int x2, int v2) {
    bool v=check_complete(x1,v1,x2,v2);
    if(v){return "YES";
    }
    return "NO";
